          ...
          <form onSubmit={handleJoinRoom} className="flex flex-col gap-5">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  className="w-full h-12 pl-10 pr-4 border-2 border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-400 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-200"
                  type="text"
