...
const UserJoin = ({ onJoin }) => {
  ...
  return (
    <div className="min-h-screen w-full bg-gradient-to-br from-gray-50 via-blue-50 to-indigo-100 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 flex items-center justify-center p-5">
      <div className="bg-white/90 dark:bg-gray-800/90 backdrop-blur-sm p-8 rounded-2xl shadow-2xl w-full max-w-lg border border-gray-200/50 dark:border-gray-700/50 flex flex-col gap-3">
        {/* Header */}
        ...
        <div className="flex gap-2 mb-6">
          <button
            ...
            className={`flex-1 px-4 py-2 rounded-lg cursor-pointer transition duration-200 font-medium ${
              !isCreatingRoom
          ...
          <button
            ...
            className={`flex-1 px-4 cursor-pointer py-3 rounded-lg transition duration-200 font-medium ${
              isCreatingRoom
        ...
        <form onSubmit={handleJoinRoom} className="flex flex-col gap-5 ">
          ...
          <button
            type="submit"
            className="w-full bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white h-12 px-6 rounded-lg transition duration-200 cursor-pointer font-semibold shadow-lg hover:shadow-xl transform hover:scale-105"
          >
